...
var socket = new _sockets2.default();
socket.initSocket(function () {
...
exports.default = function () {
  return {
    ...
    */
    initSocket: function initSocket(callback) {
      this.socket.on('questionAsked', callback);
    },
    /**
...
new _vue2.default({
  ...
  data: {
    posts: [{
      ...
      body: 'Question 1 body, what?',
      timestamp: '05-5-2017'

    }, {
      title: 'Question title 2',
      body: 'Question 2 body, what?',
      timestamp: '05-5-2017'
